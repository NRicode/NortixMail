...
1. copy your certificate and private key files into the `data` folder (usually, the file extension is `.crt` and `.key`). The file name and extension don't actually matter as Nortix Mail will automatically detect which one is which
